...
const PhaseOneTwo = ({ phase, setPhase }: any) => {
  const [done2, setDone2] = useState([false, false, false, false, false, false, false, false])

  return <div className={styles.phase1_2}>
    <video autoPlay muted loop >
      <source src="/assemble.mp4" type="video/mp4" />
    </video>
    {phase === 1 ? <>
      <p>File Encryption and Fragmentation ... (
      ...
      <>
        {done2.every(el => el) ?
          ...
          <p>Sending pieces of data to 20 hosts in 8 clouds...</p>
        }
